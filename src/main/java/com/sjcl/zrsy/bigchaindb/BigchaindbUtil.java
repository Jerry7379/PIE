...
public class BigchaindbUtil {
    ...
    public static String createAsset(Object assetObject, Object metadateObject) throws Exception {
        ...
        Transaction createTransaction = BigchainDbTransactionBuilder
                ...
                .buildAndSign(
                        (EdDSAPublicKey) KeyPairHolder.getKeyPair().getPublic(),
                        (EdDSAPrivateKey) KeyPairHolder.getKeyPair().getPrivate())
                .sendTransaction();
    ...
    public static String transferIdCardAndOperation(Object metaData,String assetId) throws Exception {
        ...
        Transaction transferTransaction = BigchainDbTransactionBuilder
                ...
                .addInput(null, transferInput(assetId), (EdDSAPublicKey) KeyPairHolder.getKeyPair().getPublic())
                ...
                .addOutput("1", (EdDSAPublicKey) KeyPairHolder.getKeyPair().getPublic())
                ...
                .buildAndSign((EdDSAPublicKey) KeyPairHolder.getKeyPair().getPublic(), (EdDSAPrivateKey) KeyPairHolder.getKeyPair().getPrivate())
                .sendTransaction();
